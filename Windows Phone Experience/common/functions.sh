...
rm -rf /data/system/users/0/wallpaper_info.xml
rm -rf /data/system/users/0/wallpaper_orig

settings put secure icon_blacklist alarm_clock,cast,headset,hotspot,mute,rotate,volte,volume,vowifi,zen
